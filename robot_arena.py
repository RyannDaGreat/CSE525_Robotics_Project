...
class ArenaState:
    ...
    def display(self):
        ...
        image=self.unwarped
        image=cv_draw_circle(image,*self.robot_center.astype(int),radius=10,color=(0,0,0))
        image=cv_draw_circle(image,*self.robot_center.astype(int),radius=9,color=(255,0,0))
        ...
        image=cv_draw_circle(image,*self.block_center.astype(int),radius=10,color=(0,0,0))
        image=cv_draw_circle(image,*self.block_center.astype(int),radius=9,color=(0,255,255))
        display_image(image)
